...
&emsp;&emsp;[Client](#Client)   
&emsp;&emsp;[Server](#Server)   
&emsp;&emsp;[Client—Server Model](#Client—ServerModel)   
&emsp;&emsp;[IPAddress](#IPAddress)   
&emsp;&emsp;[Port](#Port)   
&emsp;&emsp;[DNS](#DNS)   
...
in-memory key-value store. Does offer some persistent storage options but is typically used as a really fast, best-effort caching solution. Redis is also often used to implement rate limiting. Learn more: https://redis.io/
